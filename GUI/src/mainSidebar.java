...
public class mainSidebar extends JFrame {
    ...
    public mainSidebar() {
        initializeBuildingMessages(); // Initialize messages
        ...
        String[] categories = {
                ...
                "Dining & Cafes", "Study and Online Class Spaces", "Plazas & Gardens"
        };
        ...
        setupBackButton(backButton, mainButtonsPanel, sidebar, newFrame);
...
/*        button.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        button.setBorderPainted(false); // To remove the button border if not needed
    ...
    private JPanel createBuildingInfoPanel(String buildingName) {
        String message = buildingMessages.getOrDefault(buildingName, buildingName + "\nNo description available.");
